...
class SmallEnemy(pygame.sprite.Sprite):
    def __init__(self, bg_size):
        ...
        random.randint(0, self.width - self.rect.width), random.randint(-5 * self.rect.height, -5))
        self.active = True
    ...
    def reset(self):
        self.rect.left, self.rect.top = (
        random.randint(0, self.width - self.rect.width), random.randint(-5 * self.rect.height, 0))
        self.active = True
    # 中型敌机
...
class MidEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, bg_size):
        ...
        self.speed = 2
        self.rect.left, self.rect.top = (
        random.randint(0, self.width - self.rect.width), random.randint(-10 * self.rect.height, -self.rect.height))
        self.active = True
...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, bg_size):
        ...
        self.speed = 2
        self.rect.left, self.rect.top = (
        random.randint(0, self.width - self.rect.width), random.randint(-15 * self.rect.height, -5 * self.rect.height))
        self.active = True
            ...
            if life_num:
                for i in range(life_num):
                    screen.blit(life_img,
                                (screenwidth - i - 10 - (i + 1) * life_rect.width, screenheight - 5 - life_rect.height))
                    # 检测用户的键盘操作
            # 获得用户所有的键盘输入序列
